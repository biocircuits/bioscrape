...
TEST_NAME = "random_model_strings"
...
def test_random_propensity_outputs(prop_type):
	...
	all_strings = {"reactions": np.array([model.get_reaction_strings()]),
	  			   "ODEs": np.array([model.get_derivative_strings()])}

	test_utils.check_sim_results(TEST_NAME, all_strings)
